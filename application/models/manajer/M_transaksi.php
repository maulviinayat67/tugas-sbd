...
class M_transaksi extends CI_Model {
    ...
    $this->datatables->select('tbl_struk.id_pemesanan,tbl_pemesanan.nama_pemesan, DATE_FORMAT(tbl_pemesanan.tanggal, "%d %M %Y %k:%i:%s") AS tanggal ,tbl_pegawai.nama');
		...
		$this->datatables->add_column(
			'view',
			'<a href="transaksi/detail_harga/$1 " class="btn btn-primary btn-xs" "><span class="fa fa-book"> </span> Detail </a> <a onclick="konfirmOpenModal(\'$1\')" class="btn btn-primary btn-xs" "><span class="fa fa-check"> </span> Konfirmasi </a> ', 
			'id_pemesanan');
