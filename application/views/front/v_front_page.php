...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/plugins/slick-1.8.0/slick/slick-theme.css') ?>">
    <link rel="stylesheet" href="<?php echo base_url('assets/css/front/main-home.css') ?>">
